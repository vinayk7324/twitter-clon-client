  ...
  return (
    <div className=' flex justify-between  '>
                            <div className="   relative w-fit  ">
                                ...
                                border-[2px] text-[12px] rounded-md focus-within:border-[#5fe6e8] cursor-pointer  bg-black text-white    w-36  h-12  pt-4     twitter-text font-semibold  ' aria-placeholder='hello' name="month" id="">
                                    {
                            ...
                            <div className="   relative w-fit rounded-md  ">
                                ...
                                <select value={DOB.date} onChange={onchangeHandler} aria-invalid="false" className=' selctedArea border-[2px]  border-[2px] text-[12px]   rounded-md focus-within:border-[#5fe6e8] cursor-pointer  bg-black text-white     lg:w-32 h-12 w-20 pt-4      twitter-text font-semibold  ' aria-placeholder='hello' name="date" id="">
                                    {
                            ...
                            <div className="   relative w-fit ">
                                ...
                                <select value={DOB.year} onChange={onchangeHandler} aria-invalid="false" className=' selctedArea  border-[2px] text-[12px] rounded-md focus-within:border-[#5fe6e8] cursor-pointer  bg-black text-white    lg:w-28 h-12 w-24   pt-4  twitter-text font-semibold  ' aria-placeholder='hello' name="year" id="" >
                                    {
